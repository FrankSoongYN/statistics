...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/view/grade/class.js'></c:url>"></script>
    <style type="text/css">
...
<div class="ch-container" style='margin-top: 73px;'>
	...
	<div id="grade_form" title="添加班级" style="display: none">
			<input type="hidden" name="id" id="gradeId">
		    <p>
				<label>班级：</label><input id='name' name="name" style="widht: 600px">
			</p>
			<p>
				<label>班级主任：</label><input id='leader' name="leader" style="widht: 600px">
			</p>
			<p>
				<label>年级：</label>
